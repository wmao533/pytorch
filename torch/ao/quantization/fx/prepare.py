...
def _update_qconfig_based_on_dtype_config(
    ...
    def get_new_activation_post_process(
            ...
            backend_quant_min: Optional[float], 
            backend_quant_max: Optional[float],
            backend_scale_min: Optional[float],
    ...
    if activation is not None:
        ...
        activation = get_new_activation_post_process(
            activation,
            dtype_config.input_quant_min,
            dtype_config.input_quant_max,
            dtype_config.input_scale_min,
            "activation")
    if weight is not None:
        weight = get_new_activation_post_process(
            weight,
            dtype_config.weight_quant_min,
            dtype_config.weight_quant_max,
            dtype_config.weight_scale_min,
            "weight")
